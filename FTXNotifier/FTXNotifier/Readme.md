...
WORKDIR /src
COPY ["FTXNotifier.csproj", "FTXNotifier/"]
RUN dotnet restore "FTXNotifier/FTXNotifier.csproj"

WORKDIR "/src/FTXNotifier"
COPY . .
RUN dotnet build "FTXNotifier.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "FTXNotifier.csproj" \
...
Execute unit tests
```
cd "FTXNotifier/test/FTXNotifier.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "FTXNotifier/src/FTXNotifier"
