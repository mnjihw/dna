...
namespace NaverLogin
{
    public class LZString
    {
        ...
        static Dictionary<string, Dictionary<char, int>> BaseReverseDic { get; } = new Dictionary<string, Dictionary<char, int>>();
        private static Func<int, char> GetCharFromInt { get; } = a => Convert.ToChar(a);
